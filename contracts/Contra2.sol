...
contract Contra2 is ERC721URIStorage {
    ...
    constructor() ERC721("Contra2", "CER") {
        owner = msg.sender;
    }

    function awardCertificate(address student, string memory tokenURI) public onlyOwner returns (uint256) {
